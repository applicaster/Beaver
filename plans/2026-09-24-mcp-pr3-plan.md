...
> **As merged (after PR 2):** `AgentLink` was folded into PR 2's `JournalLink` (same JSON), and PR 2's toast Show / notification click route through `AppEnvironment.open(_:reveal: true)`. See D59.
